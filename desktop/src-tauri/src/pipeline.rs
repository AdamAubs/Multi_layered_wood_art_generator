...
#[tauri::command]
pub fn start_job(image_path: String, stock_size_in: Option<String>, bridge_count: Option<u32>, merge_visible_fraction: Option<f64>, omega_budget_factor: Option<f64>) -> Result<crate::types::JobSnapshot, String> {
